...
Para la estimación de los coeficientes $a_r$ y $b_r$, se aplicó una regresión lineal en escala logarítmica, considerando la precipitación acumulada en una ventana temporal de tres meses, código presente en \url{***}, definida como:
