...
% \footnote{Se recomienda utilizar Gitea\cite{gitea_about} para servicio hosting, no se utilizó para este proyecto por la ausencia de infraestructura por parte del equipo.}
