<script lang="ts">
	...
	import { createLoginUser } from '$lib/api/browser/endpoints/autenticación/autenticación';
	import type { BodyLoginUser } from '$lib/api/browser/schemas';
		...
		<Card.Content>
			<form onsubmit={handleSubmit}>
				<div class="grid gap-6">
					...
					>
						<span class="relative z-10 bg-card px-2 text-muted-foreground"> Or login with </span>
					</div>
					<div class="grid gap-6">
