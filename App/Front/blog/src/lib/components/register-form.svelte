<script lang="ts">
	...
	import { createRegisterUser } from '$lib/api/browser/endpoints/autenticación/autenticación';
	import type { RequestRegister } from '$lib/api/browser/schemas';
...
<div class={cn("flex flex-col gap-6", className)} {...restProps}>
	<Card.Root>
		<Card.Header class="text-center">
			...
			<Card.Description>Register with your Apple or Google account</Card.Description>
		</Card.Header>
		<Card.Content>
